  ...
  return (
    <Layout title="About" footer={'@2023'}>
      <p style={{ fontSize: '18px', padding: '10px', margin: '15px' }}>
        Welcome to News App! Stay up-to-date with breaking news, trending stories, and insightful analyses. Intuitive search functionality allows you to explore news articles tailored to your interests. Whether you are a casual reader or a news enthusiast, this app is here to provide you with a seamless and enjoyable news browsing experience.
        <br />
        <br />
